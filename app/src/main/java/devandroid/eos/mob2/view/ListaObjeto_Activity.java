...
public class ListaObjeto_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Objeto> objeto = db.objetoDao().getAll();
        ArrayAdapter<Objeto> adapter = new ArrayAdapter<>(this,
                android.R.layout.simple_spinner_dropdown_item, objeto);

        spinner = findViewById(R.id.spinnerObjeto);
